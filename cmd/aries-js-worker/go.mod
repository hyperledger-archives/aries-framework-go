...
require (
	...
	github.com/go-jose/go-jose/v3 v3.0.1-0.20210613005559-6f2534b08aeb // indirect
	...
	github.com/hyperledger/aries-framework-go/component/storageutil v0.0.0-20220106195936-a9d6794663ed // indirect
