...
func TestNewAgentParametersUsingEnv(t *testing.T) {
	t.Setenv(agentHostEnvKey, "agentHost")
	t.Setenv(agentTokenEnvKey, "agentToken")
	t.Setenv(databaseTypeEnvKey, "databaseType")
	t.Setenv(databasePrefixEnvKey, "databasePrefix")
	t.Setenv(databaseTimeoutEnvKey, "1")
	t.Setenv(agentWebhookEnvKey, "agentWebhook")
	t.Setenv(agentDefaultLabelEnvKey, "agentDefaultLabel")
	t.Setenv(agentLogLevelEnvKey, "DEBUG")
	t.Setenv(agentHTTPResolverEnvKey, "agentHTTPResolver")
	t.Setenv(agentOutboundTransportEnvKey, "agentOutboundTransport")
	t.Setenv(agentTLSCertFileEnvKey, "agentTLSCertFile")
	t.Setenv(agentTLSKeyFileEnvKey, "agentTLSKeyFile")
	t.Setenv(agentInboundHostEnvKey, "agentInboundHost")
	t.Setenv(agentInboundHostExternalEnvKey, "agentInboundHostExternal")
	t.Setenv(agentWebSocketReadLimitEnvKey, "0")
	t.Setenv(agentAutoAcceptEnvKey, "true")
	t.Setenv(agentTransportReturnRouteEnvKey, "agentTransportReturnRoute")
	t.Setenv(agentAutoExecuteRFC0593EnvKey, "true")
	t.Setenv(agentContextProviderEnvKey, "agentContextProvider")
	t.Setenv(agentKeyTypeEnvKey, "agentKeyType")
	t.Setenv(agentKeyAgreementTypeEnvKey, "agentKeyAgreementType")
	t.Setenv(agentMediaTypeProfilesEnvKey, "agentMediaTypeProfiles")
