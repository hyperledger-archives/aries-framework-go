...
Flags:
  ...
  -b, --inbound-transport string       Inbound transport type. possible values [http] [ws]. Defaults to http if not set. Alternatively, this can be set with the following environment variable: ARIESD_INBOUND_TRANSPORT  
