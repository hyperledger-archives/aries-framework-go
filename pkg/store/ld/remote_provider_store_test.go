...
func TestRemoteProviderStoreImpl_Get(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		err := storageProvider.Store.Put("id", []byte("endpoint"), storage.Tag{Name: ld.RemoteProviderRecordTag})
		require.NoError(t, err)
...
func TestRemoteProviderStoreImpl_GetAll(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		err = storageProvider.Store.Put("id2", []byte("endpoint2"), storage.Tag{Name: ld.RemoteProviderRecordTag})
		require.NoError(t, err)
