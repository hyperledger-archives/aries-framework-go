...
func (m *MockDIDComm) HandleInbound(arg0 *service.DIDCommMsg) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HandleInbound", arg0)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDIDCommMockRecorder) HandleInbound(arg0 interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HandleInbound", reflect.TypeOf((*MockDIDComm)(nil).HandleInbound), arg0)
}

// HandleOutbound mocks base method
func (m *MockDIDComm) HandleOutbound(arg0 *service.DIDCommMsg, arg1 *service.Destination) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HandleOutbound", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockDIDCommMockRecorder) HandleOutbound(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HandleOutbound", reflect.TypeOf((*MockDIDComm)(nil).HandleOutbound), arg0, arg1)
}
