...
func TestService_SkipProposal(t *testing.T) {
	...
	require.NoError(t, alice.HandleOutbound(
		introduce.WrapWithMetadataPublicInvitation(
			introduce.CreateProposal(&introduce.To{
				Name: Carol,
...
func TestService_Proposal(t *testing.T) {
	...
	require.NoError(t, alice.HandleOutbound(
		introduce.WrapWithMetadataContextID(
			introduce.CreateProposal(&introduce.To{Name: Carol}), ctxID,
		),
		Alice, Bob),
	)
	...
	require.NoError(t, alice.HandleOutbound(
		introduce.WrapWithMetadataContextID(
			introduce.CreateProposal(&introduce.To{Name: Bob}), ctxID,
		),
		Alice, Carol),
	)
}
...
func TestService_ProposalWithRequest(t *testing.T) {
	...
	require.NoError(t, bob.HandleOutbound(service.NewDIDCommMsgMap(&introduce.Request{
