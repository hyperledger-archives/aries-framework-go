...
/*
ECDHESDecrypt Interface for ECDH-ES decryption.
...
The functionality of ECDH-ES Encryption is represented as a pair of primitives (interfaces):
...
aad can be empty or null, but to ensure the correct decryption of a ciphertext
...
*/
type ECDHESDecrypt interface {
	// Decrypt operation: decrypts ciphertext verifying the integrity of aad.
