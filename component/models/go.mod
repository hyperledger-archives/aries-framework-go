...
require (
	...
	github.com/hyperledger/aries-framework-go/component/kmscrypto v0.0.0-20220322085443-50e8f9bd208b
...
replace github.com/hyperledger/aries-framework-go/component/storageutil => ../storageutil
