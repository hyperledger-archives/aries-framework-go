...
Feature: DIDComm Transport between two Agents through DIDComm Routers
  ...
  Scenario: Decentralized Identifier(DID) Exchange between two Edge Agents through Routers
    ...
    # TODO https://github.com/hyperledger/aries-framework-go/issues/1124 Add scenario - Edge agents without
    #  inbound should communicate using WebSocket with it's Router and using HTTP when sending forward messages